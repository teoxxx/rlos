...
!PATH=!PATH+'Q:\gitstuff\tempy010918SMALL'

CD, 'Q:\gitstuff\tempy010918SMALL'
pload, 3
...
CD, 'Q:\gitstuff\tempy010918SMALL\databis'
...
print, 'EDOORETASO',lose(counter),losk(counter),ll(counter),mikoscell
in=in+din(counter)
...
print, ny10, nz10,'tsa'
print, ny1current, nz1current,'tsa'
print, counterlast(ny10,nz10),'edo to counterlast'
...
print, taun
eikona(ny10,nz10)=in
print, in,eikona(ny10,nz10), 'teos'
eikonatau(ny10,nz10)=taun
counterlast(ny10,nz10)=lastcounter

openw, 16, 'Q:\gitstuff\tempy010918SMALL\databis\eikona1.eikona'
printf, 16, ny10,nz10,eikona
close, 16
...
shade_surf, ((eikona)), ax=35, az=-150, /zlog, MAX_VALUE=10000000000000000, MIN_VALUE=100000, xstyle=2, $
ystyle=2, zstyle=2, xtitle='X', ytitle='Y', ztitle='Z', xticklayout=0, background=255, color=0, xthick=2, $
